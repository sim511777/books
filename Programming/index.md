...
환경, 동시성과 병렬 프로그래밍, 컴퓨터 비전을 처음부터 새로 집필한 입문서 모음입니다. 각 책은
18~25개 장 + 부록으로 구성되어 있으며, 장마다 개념 설명·예제 코드·요약·연습문제를 담고 있습니다.
...
- **[OpenCV로 배우는 컴퓨터 비전 (Python·C++·C#)](OpenCV/OpenCV로배우는컴퓨터비전/00-목차.md)** — 같은 OpenCV 개념을 Python, C++, C# 세 언어로 나란히 비교하며 배웁니다. 이미지 기초부터 필터링, 엣지 검출, 컨투어 분석, 특징점 매칭, 얼굴/객체 검출, 실전 프로젝트까지 다룹니다.
